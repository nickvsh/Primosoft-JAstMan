 ...
 * @author atelizhenko
 */
final class AllOperatorsOfGroupAlgorithm implements OperatorAlgorithm {
	private final IAlgorithmService algorithmService;

	@Autowired
	public AllOperatorsOfGroupAlgorithm(IAlgorithmService algorithmService) {
		this.algorithmService = algorithmService;
	}

	@Override
	public List<Operator> invokeAlgorithm(String groupName) {
		return algorithmService.getAllOfGroupList(groupName);
	}
}
