...
import com.primosoft.astman.core.ast.credential.AsteriskCredentials;
 ...
 * @author atelizhenko
 */
@Service(value = "baseAsteriskServer")
class BaseAsteriskServer implements AsteriskServer {
	private final AsteriskServer asteriskServer;
	private final Logger logger;

	@Autowired
	BaseAsteriskServer(AsteriskCredentials asteriskCredentials, @Qualifier("asteriskLogger") Logger logger) {
		this.asteriskServer = asteriskCredentials.createConnection();
		this.logger = logger;
	}
	 ...
	 * {@linkplain ManagerEventListener ManagerEventListeners} before the connection
	...
	public AsteriskChannel originate(OriginateAction originateAction) throws ManagerCommunicationException, NoSuchChannelException {
		logger.debug("Generates an outgoing channel with " + originateAction);
	...
	public void originateAsync(OriginateAction originateAction, OriginateCallback cb) throws ManagerCommunicationException {
		logger.debug("Asynchronously generates an outgoing channel with " + originateAction);
	...
	public AsteriskChannel originateToExtension(String channel, String context, String exten, int priority, long timeout) throws ManagerCommunicationException, NoSuchChannelException {
		logger.debug("Generates an outgoing channel to a dialplan " +
				"entry (extension, context, priority) " +
				"{ " + channel + ", " + context + ", " + exten + ", " + priority + ", " + timeout +
				" }");
		return asteriskServer.originateToExtension(channel, context, exten, priority, timeout);
	}
	...
	public AsteriskChannel originateToExtension(String channel, String context, String exten, int priority, long timeout, CallerId callerId, Map<String, String> variables) throws ManagerCommunicationException, NoSuchChannelException {
		logger.debug("Generates an outgoing channel to a dialplan entry " +
				"(extension, context, priority) and sets an optional map of channel variables " +
				"{ " + channel + ", " + context + ", " + exten + ", "
				+ priority + ", " + timeout + ", " + callerId + ", " + variables +
				" }");
		return asteriskServer.originateToExtension(channel, context, exten, priority, timeout, callerId, variables);
	}
	...
	public AsteriskChannel originateToApplication(String channel, String application, String data, long timeout) throws ManagerCommunicationException, NoSuchChannelException {
		logger.debug("Generates an outgoing channel to an application " +
				"{ " + channel + ", " + application + ", " + data + ", " + timeout +
				" }");
		return asteriskServer.originateToApplication(channel, application, data, timeout);
	}
	...
	public AsteriskChannel originateToApplication(String channel, String application, String data, long timeout, CallerId callerId, Map<String, String> variables) throws ManagerCommunicationException, NoSuchChannelException {
		logger.debug("Generates an outgoing channel to an application and sets an optional map of channel variables " +
				"{ " + channel + ", " + application + ", " + data + ", " + timeout + ", " + callerId + ", " + variables +
				" }");
		return asteriskServer.originateToApplication(channel, application, data, timeout, callerId, variables);
	}
	 ...
	 */
	@Override
	public void originateToExtensionAsync(String channel, String context, String exten, int priority, long timeout, OriginateCallback callback) throws ManagerCommunicationException {
		logger.debug("Asynchronously generates an outgoing channel to a dialplan entry (extension, context, priority) " +
				"{ " + channel + ", " + context + ", " + exten + ", " + priority + ", " + timeout +
				" }");
		asteriskServer.originateToExtensionAsync(channel, context, exten, priority, timeout, callback);
	}
	 ...
	 */
	@Override
	public void originateToExtensionAsync(String channel, String context, String exten, int priority, long timeout, CallerId callerId, Map<String, String> variables, OriginateCallback callback) throws ManagerCommunicationException {
		logger.debug("Asynchronously generates an outgoing channel to a dialplan entry " +
				"(extension, context, priority) and sets an optional map of channel variables " +
				"{ " + channel + ", " + context + ", " + exten + ", " +
				priority + ", " + timeout + ", " + callback + ", " + variables +
				" }");
		asteriskServer.originateToExtensionAsync(channel, context, exten, priority, timeout, callerId, variables, callback);
	}
	 ...
	 */
	@Override
	public void originateToApplicationAsync(String channel, String application, String data, long timeout, OriginateCallback callback) throws ManagerCommunicationException {
		logger.debug("Asynchronously generates an outgoing channel to an application " +
				"{ " + channel + ", " + application + ", " + data + ", " + timeout +
				" }");
		asteriskServer.originateToApplicationAsync(channel, application, data, timeout, callback);
	}
	 ...
	 */
	@Override
	public void originateToApplicationAsync(String channel, String application, String data, long timeout, CallerId callerId, Map<String, String> variables, OriginateCallback callback) throws ManagerCommunicationException {
		logger.debug("Asynchronously generates an outgoing channel to an application and sets " +
				"an optional map of channel variables " +
				"{ " + channel + ", " + application + ", " + data + ", " + timeout + ", " + callback + ", " + variables +
				" }");
		asteriskServer.originateToApplicationAsync(channel, application, data, timeout, callerId, variables, callback);
	}
	...
	public Collection<MeetMeRoom> getMeetMeRooms() throws ManagerCommunicationException {
		return asteriskServer.getMeetMeRooms();
	}
	 ...
	 */
	@Override
	public MeetMeRoom getMeetMeRoom(String roomNumber) throws ManagerCommunicationException {
		return asteriskServer.getMeetMeRoom(roomNumber);
	}
	...
	public Collection<AsteriskQueue> getQueues() throws ManagerCommunicationException {
		return asteriskServer.getQueues();
	}
	...
	public int[] getVersion(String file) throws ManagerCommunicationException {
		return asteriskServer.getVersion(file);
	}
	...
	public void setGlobalVariable(String variable, String value) throws ManagerCommunicationException {
		asteriskServer.setGlobalVariable(variable, value);
	}
	...
	public Collection<Voicemailbox> getVoicemailboxes() throws ManagerCommunicationException {
		return asteriskServer.getVoicemailboxes();
	}
	...
	public List<String> executeCliCommand(String command) throws ManagerCommunicationException {
		logger.debug("Executes a command line interface (CLI) command " + command);
	...
	public boolean isModuleLoaded(String module) throws ManagerCommunicationException {
		return asteriskServer.isModuleLoaded(module);
	}
	...
	public void loadModule(String module) throws ManagerCommunicationException {
		logger.debug("Loads a module or subsystem " + module);
		asteriskServer.loadModule(module);
	}
	...
	public void unloadModule(String module) throws ManagerCommunicationException {
		logger.debug("Unloads a module or subsystem " + module);
		asteriskServer.unloadModule(module);
	}
	...
	public void reloadModule(String module) throws ManagerCommunicationException {
		logger.debug("Reloads a module or subsystem " + module);
		asteriskServer.reloadModule(module);
	}
	...
	public void reloadAllModules() throws ManagerCommunicationException {
		logger.debug("Reloads all currently loaded modules");
	...
	public ConfigFile getConfig(String filename) throws ManagerCommunicationException {
		return asteriskServer.getConfig(filename);
	}
	...
	public void removeAsteriskServerListener(AsteriskServerListener listener) {
		asteriskServer.removeAsteriskServerListener(listener);
	}
	...
	public void addChainListener(ManagerEventListener chainListener) {
		asteriskServer.addChainListener(chainListener);
	}
	...
	public void removeChainListener(ManagerEventListener chainListener) {
		asteriskServer.removeChainListener(chainListener);
	}
